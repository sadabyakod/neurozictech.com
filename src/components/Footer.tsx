        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6">
              ...
              web development, and digital transformation services to businesses worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">
                <span className="block">Phone: +91 96322 77455</span>
              </li>
              <li className="text-gray-400">
                <span className="block">Email: techinfo@neurozic.com</span>
              </li>
            </ul>
          </div>
        </div>
