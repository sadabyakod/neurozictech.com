...
function ContactForm() {
    ...
    const handleSubmit = (e)=>{
        ...
        const subject = "Contact Form Submission from ".concat(formData.name);
        const body = "Name: ".concat(formData.name, "\nEmail: ").concat(formData.email, "\nCompany: ").concat(formData.company || 'Not provided', "\n\nMessage:\n").concat(formData.message);
        // Create mailto link
        const mailtoLink = "mailto:techinfo@neurozic.com?subject=".concat(encodeURIComponent(subject), "&body=").concat(encodeURIComponent(body));
        try {
...
_s(ContactForm, "l8U/5cdU4ajn43zhrtmiZ21QxTo=");
_c = ContactForm;
var _c;
...
//# sourceMappingURL=src_components_847a50c7._.js.map